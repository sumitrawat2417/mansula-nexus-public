...
function ProfileView({ business, taxRateObj, onEdit, onRestoreBackup, onboardingStep }) {
  ...
  const generateQRCard = () => new Promise(async (resolve, reject) => {
    try {
      ...
      ctx.fillText(APP_NAME, W / 2, logoCY + logoBgR + 34)
          ...
          {taxRateObj && (
            <>
              ...
              <div style={{ marginTop: '12px', padding: '12px', backgroundColor: '#fffbfa', border: '1px solid #fee2e2', borderRadius: '12px', fontSize: '12px', color: '#6b7280', lineHeight: 1.4, display: 'flex', gap: '8px', alignItems: 'flex-start' }}>
                ...
                <div>
                  <span style={{ color: '#ef4444', fontWeight: 600 }}>Disclaimer:</span> Tax rates and business information are configured entirely by the user. {APP_NAME} is not responsible for any inaccuracies, data entry errors, or misinformation regarding user-entered details or tax compliance.
                </div>
              </div>
            </>
          )}
            ...
            <>
              ...
              <div className="bp-field">
                ...
                <div style={{ marginTop: '10px', padding: '10px', backgroundColor: '#fffbfa', border: '1px solid #fee2e2', borderRadius: '8px', fontSize: '12px', color: '#6b7280', lineHeight: 1.4, display: 'flex', gap: '8px', alignItems: 'flex-start' }}>
                  <div style={{ color: '#ef4444', flexShrink: 0, width: '16px', height: '16px', marginTop: '2px' }}><Ic.AlertTri /></div>
                  <div>
                    <span style={{ color: '#ef4444', fontWeight: 600 }}>Disclaimer:</span> Tax slabs and details are selected by the user. {APP_NAME} assumes no liability for inaccuracies or misinformation regarding applied taxes.
                  </div>
                </div>
              </div>
              <div className="bp-field">
      ...
      {tab === 'backup' && (
        <div className="bp-body">
          ...
          <div className="bp-backup-card bp-backup-import">
            ...
            <button className="bp-btn-primary" style={{ background: '#10b981', color: '#fff', border: 'none' }} onClick={() => importRef.current?.click()}>
